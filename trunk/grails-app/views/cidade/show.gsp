	...
	<body>
		...
		<div id="show-cidade" class="content scaffold-show" role="main">
			...
			<ol class="property-list cidade">
				...
				<g:if test="${cidadeInstance?.codigoIBGE}">
				<li class="fieldcontain">
					<span id="codigoIBGE-label" class="property-label"><g:message code="cidade.codigoIBGE.label" default="Codigo IBGE" /></span>
					
						<span class="property-value" aria-labelledby="codigoIBGE-label"><g:fieldValue bean="${cidadeInstance}" field="codigoIBGE"/></span>
