			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="codigoIBGE" title="${message(code: 'cidade.codigoIBGE.label', default: 'Codigo IBGE')}" />
				...
				<g:each in="${cidadeInstanceList}" status="i" var="cidadeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: cidadeInstance, field: "codigoIBGE")}</td>
