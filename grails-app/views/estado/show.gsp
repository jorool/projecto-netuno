	...
	<body>
		...
		<div id="show-estado" class="content scaffold-show" role="main">
			...
			<ol class="property-list estado">
				...
				<g:if test="${estadoInstance?.abreviacao}">
				<li class="fieldcontain">
					<span id="abreviacao-label" class="property-label"><g:message code="estado.abreviacao.label" default="Abreviacao" /></span>
					
						<span class="property-value" aria-labelledby="abreviacao-label"><g:fieldValue bean="${estadoInstance}" field="abreviacao"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${estadoInstance?.codigoIBGE}">
				<li class="fieldcontain">
					<span id="codigoIBGE-label" class="property-label"><g:message code="estado.codigoIBGE.label" default="Codigo IBGE" /></span>
					
						<span class="property-value" aria-labelledby="codigoIBGE-label"><g:fieldValue bean="${estadoInstance}" field="codigoIBGE"/></span>
