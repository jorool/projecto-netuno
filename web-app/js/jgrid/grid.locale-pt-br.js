...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Resetar",
	    odata : ['igual', 'não igual', 'menor', 'menor ou igual','maior','maior ou igual', 'começa com','não começa com','esta em','não esta em','termina com','não termina com','contém','não contém'],
